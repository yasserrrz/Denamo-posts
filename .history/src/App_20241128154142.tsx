...
const App: React.FC = () => {
  ...
  return (<>
    <Layout style={{ minHeight: '100vh' }}>
      <Header style={{ color: 'white', textAlign: 'center' ,paddingBottom: '20px'  }}>
        <Title level={2} style={{ color: 'white' , textAlign: 'center' , paddingBottom: '20px' }}>
          Posts
        </Title>
      </Header>
      ...
      <Content style={{ padding: '20px' }}>
         ...
         <Button onClick={()=>{setIsModalOpen(true)}} style={{fontSize: '16px'}} type="primary"><AddIcon/> Add Post</Button>
         </div>
