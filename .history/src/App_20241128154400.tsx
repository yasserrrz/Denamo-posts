  ...
  return (<>
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Content style={{ padding: '20px' }}>
         <div style={{marginTop: '20px ' , marginBottom: '20px' , display: 'flex', justifyContent: 'flex' }}>
         <Button onClick={()=>{setIsModalOpen(true)}} style={{fontSize: '16px' , fontWeight: '500'}} type="primary"><AddIcon/> Add Post</Button>
         </div>
