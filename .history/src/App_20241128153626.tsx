  ...
  return (<>
    <Layout style={{ minHeight: '100vh' }}>
      <Header style={{ color: 'white', textAlign: 'center' }}>
        <Title level={2} style={{ color: 'white' , textAlign: 'center' , marginBottom: '20px' }}>
          Posts
        </Title>
      </Header>
      ...
      <Content style={{ padding: '20px' }}>
         ...
         <Button onClick={()=>{setIsModalOpen(true)}} styles={{fontSize: '20px'}} type="primary"><AddIcon/> Add Post</Button>
         </div>
